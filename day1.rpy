...
label day1:
    ...
    with vpunch
    "Я недоверчиво хлопнул себя по щеке. Не сочтя это достаточной проверкой, я с силой приложился о подголовник ближайшего кресла." 
    ...
    "Я приложил руку к разгорячённому лбу{w} Голова ужасно болела."
    ...
    "Хотя кто знает, как долго меня хватит идти по ним? И кто знает, когда встретится населенный пункт?"
    ...
    "Однако это место совсем не выглядело заброшенным – ворота не были проржавевшими насквозь, белоснежные статуи задорно сверкали на солнце."
    me "«Совёнок»..."
    ...
    me "Да, спасибо..."
    show mt normal pioneer at center   with dspr
    th "Я один считаю, что ходить в такую погоду в зимнем плаще и ботинках - странновато?{w} Один, да...{w} Придётся надеть форму."
    show mt smile pioneer at center   with dspr
    ...
    "Вошел в автобус - и провалился в прошлое.{w} Потому я и сел зимой, а приехал уже летом! Точно."
