...
label day1:
    ...
    window show
    "Длинная дорога, кажущаяся бесконечной, леса и поля, сливающиеся в единое желто-зелёное месиво."
    ...
    "Поверх успокаивающе-зелёных красок открывающегося мне пейзажа я не мог разглядеть ни одного строения."
    ...
    dv "Быстрее, Токарев, Лирический! Надо облить новенького, новенький сам себя не обольёт!" #TODO Токареву и Лирическому нужны спрайты и атрибуты персонажей. Вопрос на обсуждение. 
...
label mt_pioneer_form #TODO Расписать диалог мокрого Семёна с вожатой. Плюс балл к её руту (материнские чувства, Алиса как нарушительница порядка). Мод-тян спрашивает рост Семёна и приносит ему из административного здания пионерскую форму.
    ...
    mt "Ну, она у меня ещё дождётся!{w} А что ты стоишь на пороге? Разувайся, не стесняйся! Всё уберём, если что."
    ...
    "Я заглянул внутрь в надежде найти сотовый телефон. Если мобилы тут вообще работают."
    "Не нашлось."
    th "Может, она носит его с собой..."
    "Я прекратил поиск и остановился."
    th "Почему вдруг все думают, что я один из приезжих в лагерь? Как будто я сюда целенаправленно попал!"
    th "Какая-то непонятная чушь. За все школьные годы я ни разу не ездил с одноклассниками ни заграницу, ни в санатории."
    th "И сейчас не поехал бы в лагерь, даже забесплатно."
    "Время тянулось чертовски медленно."
    "От скуки я заглянул во все незапертые тумбочки со шкафами и, не обнаружив ничего полезного, налил чаю из термоса."
    scene bg black
    $ renpy.pause(2)
    $ persistent.sprite_time = 'day'
    scene bg int_house_of_mt_day 
    ...
    "Она мило уыбнулась."
    "Я с неохотой надел форму и опять сел а столик."
    ...
    me "..."
    me "Но мои родители звонили полчаса назад?"
    ...
    "Как она тогда сумела съездить туда и обратно, я решил не спрашивать. Уже очевидно, что ответа я бы не получил."
    ...
    mt "Да это всё Алиса безоразичает."
...
label day1_camp_walk
    ...
    "Именно пионера. Это был единственный встреченный мной за сегодня представитель мужского пола." #TODO Про единственного куна уже некорректно, видоизменить предложение.
    ...
    show mt normal pioneer at center   with dissolve
    mt "Семён, сейчас мы тебе место найдем."
    ...
    window show
    "Я облегчённо рухнул на кровать. В голове проносились расплывчатые воспоминания о сегодняшнем дне."
    window hide
