...
label prologue:
    ...
    "В сети я бываю там, где нет ников и нет имён, среди людей, подобных мне."
    ...
    window show
    "Я отдавал себе отчёт, что другим это кажется слегка странноватым. Но факт есть факт – комп был мне куда ближе всех тех обезьян, бродящих по серым улицам города."
    window hide
    ...
    window show
    "Я не был несчастлив в своей запертой крепости, дверь которой открывалась лишь во время еженедельных вылазок за продуктами. Здесь я создал себе небольшой уютный мирок, и в этом мне помог единственный друг. Монитор.{w} Я пытался работать, но ограничился фрилансом с длительными перерывами.  Много ли денег мне надо было? Они либо есть, либо их нет. Я достаточно везуч – мои родители до сих пор живы."
    ...
    "Сегодня у меня необычный день. Я был приглашен на встречу моих институтских товарищей, которых я толком и не знал. И я ожидаемо не смог сказать «нет». Меня уговорил один из немногочисленных знакомых - бывший одногруппник. Он хоть и неплохой парень, но всё же не сравнится с компьютером."
    ...
    window show
    "Яркое солнце, шелест листвы. Вокруг бегают дети.{w} Мои друзья. Смех, слёзы, обида. Всё такое настоящее."
    "Мечты, надежды, цели. Я не хотел стать космонавтом, но я ни на секунду не сомневался, что стану важным.{w} Стану нужным."
    "Стану умным.{w} Красивым.{w} Встречу такую же умницу-красавицу, которая полюбит меня с первого взгляда.{w} Я для неё, она для меня."
