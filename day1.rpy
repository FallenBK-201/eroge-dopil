...
label day1:
    ...
    "Я сдержал поток слов, готовых вырваться у меня.{w} Шестым чувством я заподозрил что-то неладное. Совсем не хочу сейчас оказаться в центре внимания среди кучи неизвестных мне ребят."
    me "Мне надо идти."
    ...
    "Пионеры что-то радостно закричали, где-то сбоку показалась троица неизвестных парнишек тащили три полных ведра, от спешки чуть расплёскивая воду."
    ...
    menu:
        ...
        th "Та девочка сказала идти налево, кажется..."
        ...
        dv "Й-а-а-а-ай!!!"
        "Взвизгнула она, тут же прикрываясь, и в этот момент я с безумным смешком, если не хохотом, выкрутился из хватки и косо, как ракета Протон-М, рванул в сторону, избегая пионеров."
        me "У-ха-ха!"
        ...
        "За мной слышались крики и смех."
        ...
        th "Здесь мржно отсидеться, здесь можно отсидеться..."
    ...
    #TODO Вырезать, начиная отсюда. $ persistent.sprite_time = 'day'
...
label mt_pioneer_form #TODO Расписать диалог мокрого Семёна с вожатой. Плюс бал к её руту (материнские чувства, Алиса как нарушительница порядка). Мод-тян спрашивает рост Семёна и приносит ему из административного здания пионерскую форму.
